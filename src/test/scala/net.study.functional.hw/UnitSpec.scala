...
import org.scalatest.{BeforeAndAfter, BeforeAndAfterEach, FunSuite, GivenWhenThen, Ignore, Matchers, OptionValues, WordSpec}
...
abstract class UnitSpec extends FunSuite
  ...
  with BeforeAndAfter with BeforeAndAfterEach with MockFactory {
